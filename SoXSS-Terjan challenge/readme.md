...
Furthermore, at the following link (https://so-xss.terjanq.me/iframe.php/?source) it is possible to notice another part of the code, here the goal is very straightforward, the highlighted condition need to be bypassed in order to reach the sink and execute XSS.
