...
Fortunately during my test i also tried to put an email in the note field wich helped me to find a hidden feature (the mailto attribute did not appear with other types of inputs).
